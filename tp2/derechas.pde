void diagDer() {
  ...
  for (int i=0; i<5; i++) {
    for (int j=0; j<5; j++) {
      ...
      float distancia = dist(i*tamX*6, j*tamY, 400, 200);
      float miColor = map(distancia, 100, 500, 250, 110);
  ...
  for (int i=0; i<7; i++) {
    for (int j=0; j<7; j++) {
      pushMatrix();
      translate(i*tamX*1.9, j*tamY*1.15);
      float distancia = dist(i*tamX, j*tamY*5, 200, 400);
  ...
  for (int i=0; i<11; i++) {
    for (int j=0; j<11; j++) {
      ...
      float distancia = dist(i*tamX, j*tamY*1.1, 40, 70);
      float miColor = map(distancia, 20, 70, 80, 200);
      fill(miColor*1.4, miColor/1.1, miColor/3);
      rotate(radians(45));
